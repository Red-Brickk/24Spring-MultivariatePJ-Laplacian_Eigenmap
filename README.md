...
1. 討論確定，5月11日（週六）21：00匯總簡報初稿，5月12日（週日）21：00試講。週日白天，大家也可以查看製作好的簡報內容。
2. 分工的情況，大概是5個人講解各自負責的部分，時間控制在5分鐘左右，最後會根據內容多少做適當調整。考慮到時間緊湊，請coding的同學們呈現關鍵內容，如 “直觀的降維效果”，“調節參數所見參數效果”，“遇見問題及原因”，“與其它方法的對比”等。
3. 需要大家提出2個問題，理論問題，已有 “若一圖包含k個不相連通的子圖，其Laplacian有k個特征值為0”及“從Graph Embedding視角比較 LE、Linearized Graph Embedding、PCA、MDS”兩個備選問題。而【應用問題尚未確定】，請留意。
4. 對於疑難問題的解答：

在evaluation方面，未得到滿意的結果。主要原因是，優化目標函數的自變量為Y而含有L。而L會隨著我們構圖方式的不同而改變。不同構圖方式得到的目標函數之間沒有可比性。事實上，有監督Clustering可以直接以分類正確率作為評價指標，倒是比較方便。

在embedding方面，有找到文章對此問題進行回應。大致理解其精神，但實用性尚未待驗證。

5. 待匯報結束後，再專心處理Report的相關問題。

0512 Meeting

朋友們晚上好！以下是本次討論的紀要：

1. 試講用時29min57s，還需大家優化講解內容，爭取將用時控制在25min以內。
2. 部分修改建議，已經總結在word文檔中，請大家在明晚之前完成PPT的修改。週二上午不再統一試講，但還是請大家認真通讀全部PPT。
3. 週二當天無需早到，正常上課即可。相信我們能夠圓滿順利完成匯報！
